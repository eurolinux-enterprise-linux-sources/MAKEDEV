...
b $STORAGE              95   0  4  64 dasd%d
b $STORAGE              95   1  4  64 dasd%da
b $STORAGE              95   2  4  64 dasd%db
b $STORAGE              95   3  4  64 dasd%dc

c $STORAGE              96   0  1  16 pt%d
c $STORAGE              96 128  1  16 npt%d

b $STORAGE              96   0  1   8 msd%d

c $STORAGE              97   0  1   4 pg%d
b $STORAGE              97   0  1   4 pktcdvd%d

c $ROOT                 98   0  1   4 comedi%d
b $STORAGE              98   0  1   8 ubd%d
...
c $ROOT                118   0  1  16 solnp%d
c $ROOT                118 128  1  16 solnpctl%d

c $ROOT                119   0  1  16 vnet%d
